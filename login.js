...
con.connect(function(err) {
  ...
  // var sql = "CREATE TABLE accounts (id INT(50), username VARCHAR(50), password VARCHAR(50), email VARCHAR(50))";
  // con.query(sql, function (err, result) {
//    if (err) throw err;
//     console.log("Table created");
//   });
  var insertQuery= "INSERT INTO accounts (id, username, password, email) VALUES (1, 'Tseku', 0919, 'tsee09@gmail.com')";
